...
apply_human_artifacts() {
  ...
  case "$preset" in
    ...
    interview)
      ...
      ;;
    clean|*)
      noise_gain="0.020"; click_gain="0.000"; hiss_gain="0.004"; leading_pad_ms="160"
